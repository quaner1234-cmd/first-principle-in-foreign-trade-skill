...
| 客户要求下一件样 | 先判目的：development / validation / PP，不按样品次数命名 |
| 有现成相关资料 | Available Asset Before Ask：低成本且不扩大承诺时本轮直接提供 |
...
Current Key Uncertainty = 下一步最值得弄清什么｜Decision Barrier = 谁还不能决定、为什么｜Hard Blocker = 是否真的无法继续推进
...
- ❌ 按客户问题顺序判断优先级；按“第几次样”判断样品阶段；回复逐条复述
